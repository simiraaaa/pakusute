...
!function (phina, undefined) {
  ...
  */
  ...
  phina.main(function () {
    app = phina.display.CanvasApp({query:'#world',width:640,height:640});
    app.enableStats();
    ...
    app.pushScene(phina.game.LoadingScene({
      width: SCREEN_SIZE,
      height: SCREEN_SIZE,
      assets: ASSETS,
    }).on('exit', function() {
  ...
  var GameScene = phina.define('', {
    ...
    init: function () {
      ...
      KeyButton.SE = [sounds.se, sounds.snare, sounds.snare, sounds.se];
  ...
  var KeyButton = phina.define('', {
    ...
    init: function (index) {
      ...
      this.addChild(Label({text:this.type,fontSize:this.width}));
    },
    ...
    _static: {
      ...
      KEY_PARAM: [
          {
            fill: 'rgba(200,85,85,0.5)',
            stroke: '#f77',
          },
          {
            fill: 'rgba(85,85,200,0.5)',
            stroke: '#77f',
          },
          {
            fill: 'rgba(85,200,85,0.5)',
            stroke: '#7f7',
          },
          {
            fill: 'rgba(190,190,50,0.5)',
            stroke: 'yellow',
          },
      ],
